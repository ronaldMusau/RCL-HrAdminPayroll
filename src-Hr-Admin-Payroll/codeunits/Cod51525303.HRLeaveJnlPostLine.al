codeunit 51525303 "HR Leave Jnl.- Post Line"
{
    ...
    trigger OnRun()
    var
        TempJnlLineDim2: Record "Journal Line Dimension2" temporary;
    begin
    ...
    var
        ...
        TempJnlLineDim: Record "Journal Line Dimension2" temporary;
        InsuranceJnlCheckLine: Codeunit "HR Leave Jnl.- Check Line";
        MakeInsCoverageLedgEntry: Codeunit "HR Make Leave Ledg. Entry";
        DimMgt: Codeunit DimensionManagement;
        NextEntryNo: Integer;

    procedure RunWithCheck(var InsuranceJnlLine2: Record "HR Leave Journal Line"; var TempJnlLineDim2: Record "Journal Line Dimension2")
    begin
    ...
    procedure RunWithOutCheck(var InsuranceJnlLine2: Record "HR Leave Journal Line"; var TempJnlLineDim2: Record "Journal Line Dimension2")
    begin
        InsuranceJnlLine.Copy(InsuranceJnlLine2);
        TempJnlLineDim.Reset;
        TempJnlLineDim.DeleteAll;
    ...
    begin
        ...
        //InsCoverageLedgEntry.IsMonthlyAccrued:=
