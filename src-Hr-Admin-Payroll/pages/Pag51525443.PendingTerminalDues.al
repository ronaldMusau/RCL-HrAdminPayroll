page 51525443 "Pending Terminal Dues"
{
    ApplicationArea = All;
    Caption = 'Pending Terminal Dues';
    PageType = List;
    SourceTable = "Terminal Dues Header";
    CardPageId = "Terminal Dues Card";
    UsageCategory = Lists;
    DeleteAllowed = false;
    SourceTableView = sorting("No.") WHERE(Type = const("Final Dues"), "Approval Status" = CONST("Pending Approval"));
