page 51525438 "Paused Loan transaction"
{
    ApplicationArea = All;
    ...
    Editable = false;
    DeleteAllowed = false;
    SourceTableView = WHERE("Start Deducting" = CONST(true), Pause = CONST(true), Suspend = CONST(false), cleared = CONST(false));
            ...
            action("Restart Deductions")
            {
                ...
                begin
                    ...
                    if LoanTrans.Find('-') then begin
                        ...
                        LoanTrans.ModifyAll(Pause, false);
