page 51525334 "Failed Second Interview List"
{
    ApplicationArea = All;
    ...
    SourceTableView = WHERE("Failed Second Interview" = CONST(false));
            ...
            action("General Regret")
            {
                ...
                begin
                    ...
                    if RecruitmentNeed.FindFirst() then begin
                        ...
                        if (RecruitmentNeed."Regret Emailed") then begin
                            if not confirm('The regret message was already sent on ' + format(RecruitmentNeed."Regret Emailed On") + '. Do you still want to send?') then
                        ...
                        Window.close();
                        RecruitmentNeed."Regret Emailed" := true;
                        RecruitmentNeed."Regret Emailed On" := CREATEDATETIME(TODAY, TIME);
