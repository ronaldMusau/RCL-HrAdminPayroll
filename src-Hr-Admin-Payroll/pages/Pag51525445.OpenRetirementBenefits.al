page 51525445 "Open Retirement Benefits"
{
    ApplicationArea = All;
    Caption = 'Open Retirement Benefits';
    PageType = List;
    SourceTable = "Terminal Dues Header";
    UsageCategory = Lists;
    CardPageId = "Retirement Benefits Card";
    SourceTableView = sorting("No.") WHERE(Type = const("Retirement Benefits"), "Approval Status" = filter(Open | Rejected));
