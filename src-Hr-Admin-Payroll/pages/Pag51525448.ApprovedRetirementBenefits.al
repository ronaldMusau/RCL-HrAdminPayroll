page 51525448 "Approved Retirement Benefits"
{
    ApplicationArea = All;
    Caption = 'Approved Retirement Benefits';
    PageType = List;
    SourceTable = "Terminal Dues Header";
    CardPageId = "Retirement Benefits Card";
    UsageCategory = Lists;
    SourceTableView = sorting("No.") order(descending) WHERE(Type = const("Retirement Benefits"), "Approval Status" = filter(Released));
