table 51525396 Applicants
{
    ...
    begin
        if "Applicant No." = '' then begin
            ...
            "Applicant No." := NoSeriesMgt.GetNextNo(HumanResSetup."Applicants Nos.");
        end;
    end;
    ...
    procedure EmployeeApplicant(var Applicants: Record Applicants)
    var
        Employee: Record Employee;
    begin
        Message('cool');
        if Applicants."Applicant Type" = Applicants."Applicant Type"::External then begin
            ...
            Employee."Country/Region Code" := Applicants.County;
