report 51525324 "MMI Report"
{
    ApplicationArea = All;
    Caption = 'MMI Report';
    UsageCategory = ReportsAndAnalysis;
    RDLCLayout = './src/reports/layouts/MMIReport.rdlc';
    dataset
    {
        dataitem(Employee; Employee)
        {
            ...
            begin
                ...
                //AssignmentMatrix.SetRange(Code, 'D09'); //MMI
                ...
                if AssignmentMatrix.FindSet() then
                    repeat
                        ...
                        if AssignmentMatrix."MMI Deduction" /*.Code = 'D09'*/ then //MMI
                            begin
