report 51525323 "Pension Monthly Annexture"
{
    ApplicationArea = All;
    Caption = 'Pension Monthly Annexture';
    UsageCategory = ReportsAndAnalysis;
    RDLCLayout = './src/reports/layouts/PensionMonthlyAnnexture.rdlc';
    dataset
    {
        dataitem(Employee; Employee)
        {
            ...
            var
                ...
                HasNoTransportAllowance: Boolean;
            begin
                BasicSalary := 0;
                ...
                if AssignmentMatrix.FindSet() then
                    repeat
                        ...
                        if AssignmentMatrix."Transport Allowance" /*.Code IN ['R4', 'E04']*/ then //Transport
                            ...
                            HasNoTransportAllowance := false;
                        end;
                        if AssignmentMatrix."Basic Salary Code" then
                            TwoPointFiveMedical := 2.5 / 100 * TransAmount;
                        //Get house allowance to add to basic and use gross in case there is no transport
                        /*if AssignmentMatrix."Housing Allowance" then
                            HouseAllowance += TransAmount;*/
                        if AssignmentMatrix."Medical Insurance Deduction" then
                            IsRAMA := true;
                        TransAmount := 0;
                ...
                /*if HasNoTransportAllowance then
                    TotalRemuneration := (TotalRemuneration + HouseAllowance);*/
