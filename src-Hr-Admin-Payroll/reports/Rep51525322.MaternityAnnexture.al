report 51525322 "Maternity Annexture"
{
    ApplicationArea = All;
    Caption = 'Maternity Annexture';
    UsageCategory = ReportsAndAnalysis;
    RDLCLayout = './src/reports/layouts/MaternityAnnexture.rdlc';
    dataset
    {
        dataitem(Employee; Employee)
        {
            ...
            begin
                ...
                //AssignmentMatrix.SetRange(Code, 'D04'); //Maternity Leave Deduction
                ...
                if AssignmentMatrix.FindSet() then
                    repeat
                        ...
                        if TransAmount > 0 then
                            SkipEmployee := false;
                        if AssignmentMatrix."Maternity Leave Deduction" /*.Code = 'D04'*/ then //Maternity Leave Deduction
                            TotalContribution += TransAmount;
                        if (AssignmentMatrix.Type = AssignmentMatrix.Type::Payment) and (not AssignmentMatrix."Non-Cash Benefit") and (not AssignmentMatrix."Transport Allowance") then //Gross less transport
