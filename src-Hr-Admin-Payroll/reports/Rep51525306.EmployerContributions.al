report 51525306 "Employer Contributions"
{
    DefaultLayout = RDLC;
    Caption = 'Employer Contributions';
    RDLCLayout = './src/reports/layouts/EmployerContributions.rdlc';
    ...
    dataset
    {
        dataitem("Assignment Matrix"; "Assignment Matrix")
        {
            ...
            column(Country; "Assignment Matrix".Country)
            { }
            ...
            column(Assignment_Matrix_X1__Assignment_Matrix_X1__Amount; TransAmount/*"Assignment Matrix".Amount * -1*/)
            {
            }
            ...
            dataitem(Employee; Employee)
            {
                ...
                DataItemTableView = WHERE(Status = CONST(Active), Board = FILTER(false));
            }

            trigger OnAfterGetRecord()
            begin
                /*if "Assignment Matrix".GetFilter(Country) = '' then
                    Error('You must select a payroll country!');*/
                TransAmount := Round(GetInDesiredCurrency("Assignment Matrix"."Country Currency", "Assignment Matrix".Country, ABS("Assignment Matrix"."Employer Amount")));
