...
Table 52211676 "Strategy Sub_Activity Entry"
{
    ...
    fields
    {
        ...
        field(35; "Q1 Achieved Target"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(36; "Q2 Achieved Target"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(37; "Q3 AchievedTarget"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(38; "Q4 Achieved Target"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(39; "Achieved Weight(%)"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(40; "Remaining Targets"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
