...
Report 52211652 "PRM Consolidated Workplan Plan"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/Performance/Layouts/PRM Consolidated Workplan Plan.rdlc';
    Caption = 'PRM Consolidated Workplan Plan';
